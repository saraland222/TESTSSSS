...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      //color: Colors.red,
      padding: EdgeInsets.only(top: 8.0, left: 10, right: 10, bottom: 8),
      child: Row(
        children: [
          Material(
            elevation: 5,
              borderRadius: BorderRadius.circular(10),
              child: SizedBox(height: 140, width: 130,
                child: ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: Text(document.data()['weight'],style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Colors.grey))),
                    SizedBox(height: 6),
                    Row(
                      children: [
                        ...
                        Text('\$${document.data()['comparedPrice'].toStringAsFixed(0)}',style: TextStyle(decoration: TextDecoration.lineThrough, color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 12),)
                      ],
                    ),
                  ],
                ),
